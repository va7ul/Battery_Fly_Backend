...
const orderSchema = new Schema(
    {   
        ...
        // Сума передоплати для накладеного платежу. Рахується один раз при
        // створенні замовлення (20% від together) і зберігається, щоб картка
        // й майбутні повідомлення показували те саме число, навіть якщо
        // відсоток згодом зміниться в налаштуваннях.
        prepaymentAmount: {
            type: Number,
            default: null,
        },

...
const orderJournalSchema = new Schema(
  {
    ...
    type: {
      ...
      //
      // ⚠️ np_status — статус ПОСИЛКИ в Новій Пошті, а не статус замовлення.
      // Окремий тип, а не 'status', саме тому: замовлення може тижнями стояти у
      // «Відправлено», поки посилка проходить через п'ять станів Пошти, і
      // змішувати ці два рухи в одному типі означало б утратити різницю між
      // «ми перевели замовлення» і «Пошта зрушила коробку».
      enum: ['note', 'status', 'ttn', 'np_status', 'system'],
      required: true,
    },
